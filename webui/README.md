...
Apprise notifications are configured with `apprise_urls` in `config/settings.json`:
...
They cover session start, fatal errors, claimed drops, and each 5% progress bucket.
